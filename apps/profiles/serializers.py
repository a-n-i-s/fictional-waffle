...
class ProfileSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["username","first_name","last_name","full_name",
                  "email","id","phonenumber","profile_photo","about_me","license","gender","country","city",
                  "is_buyer","is_seller","is_agent","rating","num_reviews","reviews"]
...
class UpdateProfileSerializer(ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ["phonenumber","profile_photo","about_me","license","gender","country","city",
