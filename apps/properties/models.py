...
class Property(models.Model):
    ...
    ref_code = models.CharField(verbose_name=_("Property referrance code"),max_length=255,unique=True,blank=True)
    ...
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=100, default = "000")
    street_address = models.CharField(verbose_name=_("Street Address"),max_length=150, default = "address of street")
    ...
    tax = models.DecimalField(verbose_name=_("Tax"),decimal_places=2, default=.15,max_digits=4)
    ...
    bathrooms = models.DecimalField(verbose_name=_("Number of Bathrooms"),max_digits=4,decimal_places=2,default = 1.0)
    advert_type = models.CharField(verbose_name=_("Advert Type"), max_length=100, choices=Advertype.choices ,default=Advertype.FOR_SALE)
    property_type = models.CharField(verbose_name=_("Property Type"), max_length=100, choices=PropertyType.choices ,default=PropertyType.APARTMENT)
