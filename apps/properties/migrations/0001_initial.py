# Generated by Django 3.2.7 on 2023-10-29 04:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Property referrance code')),
                ...
                ('postal_code', models.CharField(default='000', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='address of street', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, max_digits=4, verbose_name='Tax')),
                ...
                ('bathrooms', models.DecimalField(decimal_places=2, default=1.0, max_digits=4, verbose_name='Number of Bathrooms')),
                ('advert_type', models.CharField(choices=[('For SALE', 'FOR SALE'), ('For Rent', 'FOR Rent'), ('Auction', 'Auction')], default='For SALE', max_length=100, verbose_name='Advert Type')),
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartment', 'Apartment'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Apartment', max_length=100, verbose_name='Property Type')),
